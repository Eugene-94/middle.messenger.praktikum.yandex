import BlockAbstract from "../block/block.abstract.ts";
...
export abstract class ControlAbstract<Props extends Record<string, any> = any> extends BlockAbstract<Props> implements Validatable {
...
export interface Validatable {
    ...
    runValidators: (control: ControlAbstract) => void;
}
